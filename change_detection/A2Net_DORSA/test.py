...
from models.model import BaseNet_DORSA_T, BaseNet_MobileNetv2
...
def ValidateSegmentation(args):
    ...
    if args.backbone == 'dorsa_t':
        model = BaseNet_DORSA_T(pretrained=True)
    elif args.backbone == 'mobilenetv2':
        model = BaseNet_MobileNetv2(3, 1, pretrained=True)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="LEVIR", help='Data directory | LEVIR | CDD | SYSU ')
