...
def mobilenet_v2_10(pretrained=None, progress=False, num_classes=1000, width_mult=1.0, **kwargs):
    model = MobileNetV2(num_classes=num_classes, width_mult=width_mult, **kwargs)
    if pretrained:
...
def mobilenet_v2_20(pretrained=None, progress=False, num_classes=1000, width_mult=2.0, **kwargs):
    model = MobileNetV2(num_classes=num_classes, width_mult=width_mult, **kwargs)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['mobilenet_v2'],
                                              progress=progress)
...
def mobilenet_v2_25(pretrained=None, progress=False, num_classes=1000, width_mult=2.5, **kwargs):
    model = MobileNetV2(num_classes=num_classes, width_mult=width_mult, **kwargs)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['mobilenet_v2'],
                                              progress=progress)
