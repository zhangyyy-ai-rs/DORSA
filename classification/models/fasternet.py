...
def fasternet_t0(num_classes: int = 1000, **kwargs):
    model = FasterNet(in_chans=3,
...
def fasternet_t1(num_classes: int = 1000, **kwargs):
    model = FasterNet(in_chans=3,
                      num_classes=num_classes,
                      embed_dim=64,
                      depths=(1, 2, 8, 2),
...
def fasternet_t2(num_classes: int = 1000, **kwargs):
    model = FasterNet(in_chans=3,
                      num_classes=num_classes,
                      embed_dim=96,
                      depths=(1, 2, 8, 2),
