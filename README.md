...
Large checkpoints are not tracked in this repository. Put ImageNet-1K pretrained DORSA weights in the task-specific weight path before training downstream tasks.

Recommended checkpoint name:

```text
dorsa_t_imagenet_backbone.pth
```
